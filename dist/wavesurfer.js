    ...
    _createClass(WaveSurfer, [{
            ...
            if (typeof peaks == 'string') {
                ...
                xmlHttp.onreadystatechange = function () {
                    if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
                        ...
                        switch (_this11.params.backend) {
                            case 'WebAudio':
                                return _this11.loadBuffer(url, response.data, duration);
                            case 'MediaElement':
                                return _this11.loadMediaElement(url, response.data, preload, duration);
                        }
                    }
                };
        ...
        value: function loadBuffer(url, peaks, duration) {
            ...
            var load = function load(action) {
                if (action) {
                    _this12.tmpEvents.push(_this12.once('ready', action));
                }
                return _this12.getArrayBuffer(url, function (data) {
                    return _this12.loadArrayBuffer(data);
                });
            };
        ...
        value: function loadMediaElement(urlOrElt, peaks, preload, duration) {
            ...
            this.tmpEvents.push(this.backend.once('canplay', function () {
                _this13.drawBuffer();
                _this13.fireEvent('ready');
                _this13.isReady = true;
            }), this.backend.once('error', function (err) {
                return _this13.fireEvent('error', err);
            }));
            ...
            if ((!peaks || this.params.forceDecode) && this.backend.supportsWebAudio()) {
                this.getArrayBuffer(url, function (arraybuffer) {
                    _this13.decodeArrayBuffer(arraybuffer, function (buffer) {
                        _this13.backend.buffer = buffer;
                        _this13.backend.setPeaks(null);
                        _this13.drawBuffer();
                        _this13.fireEvent('waveform-ready');
                    });
                });
            }
        }
        ...
        value: function decodeArrayBuffer(arraybuffer, callback) {
            ...
            this.backend.decodeArrayBuffer(arraybuffer, function (data) {
                ...
                if (!_this14.isDestroyed && _this14.arraybuffer == arraybuffer) {
                    callback(data);
                    _this14.arraybuffer = null;
                }
            }, function () {
                return _this14.fireEvent('error', 'Error decoding audiobuffer');
            });
        }
        ...
        value: function getArrayBuffer(url, callback) {
            ...
            this.tmpEvents.push(ajax.on('progress', function (e) {
                _this15.onProgress(e);
            }), ajax.on('success', function (data, e) {
                callback(data);
                _this15.currentAjax = null;
            }), ajax.on('error', function (e) {
                _this15.fireEvent('error', 'XHR error: ' + e.target.statusText);
                _this15.currentAjax = null;
            }));
